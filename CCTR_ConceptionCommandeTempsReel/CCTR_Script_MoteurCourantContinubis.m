...
alpha = 1.8897e7 / 1.327e5 ; % approximation pour i_2(t)
beta  = 4.3974e5 / 7745    ; % !!!
...
% poles desires
poles_des = [-10; -15]; % tr = 0.3s pour -10 et -15 pour un pole + rapide

% gain
G2 = acker(A2', C2', poles_des)';

% systeme obs
uBOy_obs = ss(A2-G2*C2, B2, C2, D2);